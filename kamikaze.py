...
from scraper import technopark_url, click_startup_link, click_startup_website_icon, click_the_triangle_button, get_page_startups_links, initialize_driver
...
def kamikaze(n_pages, n_startup):
    ...
    if clicked_icon:  
        ...
        try: 
            ...
            log.warning(f"Kamikaze: Mission failed: exception: {e}")
            startup_website = "N/A"
    else: 
